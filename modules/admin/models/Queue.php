 ...
 */
class Queue extends RedActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('url, postdata, status, gmt_create, gmt_modified', 'required'),
            array('status', 'numerical', 'integerOnly'=>true),
            array('url', 'length', 'max'=>255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, url, postdata, status, gmt_create, gmt_modified', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('postdata',$this->postdata,true);
